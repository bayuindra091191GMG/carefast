...
//            }
            ...
            if($user->employee->employee_role_id > 4){
                $accessible_menus = "1,601,2,8,4,5,6,301,302,311,312,321,102";
            }
            else if($user->employee->employee_role_id == 1){
                $accessible_menus = "1,601,2,8,3,301,311,102";
            }
            else{
                $accessible_menus = "1,601,4,8,5,6,11,301,302,311,312,321,102";
            }
