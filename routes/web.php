...
//    Route::get('/', 'Admin\DashboardController@dashboard')->name('admin.dashboard');
    ...
    Route::post('/project/attendance/download-insys', 'Admin\project\ProjectAttendanceController@downloadAttendanceInsys')->name('admin.project.attendance.download-insys');
...
//    Route::get('/project/activity/create-step-2/', 'Admin\project\ActivityController@createStepTwo')->name('admin.project.activity.create-two');
    ...
    Route::get('/project/activity/download-file/{id}', 'Admin\project\ActivityController@downloadEmployeePlotting')->name('admin.project.activity.download-file');
...
Route::get('/select-oms', 'Admin\project\ProjectController@getOms')->name('select.oms');
