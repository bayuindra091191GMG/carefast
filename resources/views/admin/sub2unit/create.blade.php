...
<div class="row">
    <div class="col-12">
        <div class="card-body">
            <div class="row">
                <div class="col">
                    <h3>TAMBAH BARU Sub Unit 2</h3>
                </div>
            </div>

            {{ Form::open(['route'=>['admin.sub2unit.store'],'method' => 'post','id' => 'general-form']) }}
                    ...
                    <div class="card">
                        <div class="card-body b-b">
                            ...
                            <div class="col-md-11 col-sm-11 col-xs-12" style="margin: 3% 0 3% 0;">
                                <a href="{{ route('admin.sub2unit.index') }}" class="btn btn-danger">BATAL</a>
