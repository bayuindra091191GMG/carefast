...
<div class="row">
    <div class="col-12">
        <div class="card-body">
            <div class="row">
                <div class="col">
                    <h3>UBAH JABATAN KARYAWAN</h3>
                </div>
            </div>

            {{ Form::open(['route'=>['admin.employee_role.update', $employeeRole->id],'method' => 'post','id' => 'general-form']) }}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body b-b">
                            <div class="body">
                                    ...
                                    <div class="form-group form-float form-group-lg">
                                        <div class="form-line">
                                            ...
                                            <textarea id="description" class="form-control" name="description"
                                                rows="4">{{ $employeeRole->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {{ $employee->name . ' - ' . $unit->description }}
                                </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="col-md-11 col-sm-11 col-xs-12" style="margin: 3% 0 3% 0;">
                        <a href="{{ route('admin.employee_role.index') }}" class="btn btn-danger">BATAL</a>
