            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4 col-12 text-right">
                        <a href="{{ route('admin.sales_order.index') }}" class="btn btn-danger">BATAL</a>
                ...
                {{ Form::open(['route'=>['admin.project.employee.store'],'method' => 'post','id' => 'general-form']) }}
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group form-float form-group-lg">
                                                    <div class="form-line">
                                                        <label class="form-label" for="code">Project Name</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group form-float form-group-lg">
                                                    <div class="form-line">
                                                        ...
                                                        <input type="hidden" id="manpower" name="manpower" value="{{ ($project->total_manpower - 1) }}"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <table id="upper_employee_table" class="table table-striped table-bordered nowrap">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center">ROLE/POSISI</th>
                                            ...
                                            <tr id="upper_employee_row_0">
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-danger text-white" style="cursor: pointer;" onclick="deleteRow(0);">HAPUS</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
    ...
    <script type="text/javascript">
        ...
        function addRow(){
            ...
            let newRow = '<tr id="upper_employee_row_' + idx + '">' +
                ...
                '<td class="text-center"><a class="btn btn-danger text-white" style="cursor: pointer;" onclick="deleteRow(' + idx + ')">HAPUS</a></td>' +
                '</tr>';
        ...
        function deleteRow(rowIdx){
            ...
            $('#upper_employee_row_' + deletedIdx).remove();
