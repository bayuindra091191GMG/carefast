    ...
    <div class="row">
        <div class="col-12">
            <div class="card-body">
                ...
                {{ Form::open(['route'=>['admin.place.update', $place->id],'method' => 'post','id' => 'general-form']) }}
                                        ...
                                        <div class="form-group form-float form-group-lg">
                                            <div class="form-line">
                                                ...
                                                <textarea id="description" class="form-control"
                                                          name="description" rows="4">{{ $place->description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group form-float form-group-lg">
                                            <div class="form-line">
                                                ...
                                                <select class="form-control" id="status" name="status">
                                                    <option value="1" @if($place->status_id === 1) selected @endif>ACTIVE</option>
                                                    <option value="2" @if($place->status_id === 2) selected @endif>NON-ACTIVE</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
