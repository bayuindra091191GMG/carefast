...
<aside class="left-sidebar" data-sidebarbg="skin5">
    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            {{ $fmId = \Illuminate\Support\Facades\Auth::guard('admin')->user()->fm_id }}
            @if($projectId != 0)
                <ul id="sidebarnav" class="pt-3 mt-3" style="border-top: 1px solid #eeeeee;">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item">
                                <a href="{{ route('admin.project.information.show', ['id' => $projectId]) }}" class="sidebar-link">
                                    <i class="mdi mdi-account"></i>
                                    <span class="hide-menu"> Project Detail </span>
                                </a>
                            </li>
                        </ul>
                    </li>
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ route('admin.project.attendance.download-form') }}" class="sidebar-link">
                                        <i class="mdi mdi-account"></i>
                                        <span class="hide-menu"> Download Project Absensi </span>
                                    </a>
                                </li>
                            </ul>
                        </li>
